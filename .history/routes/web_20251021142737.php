...
// Halaman utama operational report
Route::get('/report/operational', [OperationalReportController::class, 'index'])
    ->name('report.operational.index');

// Store data pelanggan baru
Route::post('/report/operational/store', [OperationalReportController::class, 'store'])
    ->name('report.operational.store');

// Halaman edit pelanggan
Route::get('/report/operational/{id}/edit', [OperationalReportController::class, 'edit'])
    ->name('report.operational.edit');

// Update data pelanggan
Route::put('/report/operational/{id}', [OperationalReportController::class, 'update'])
    ->name('report.operational.update');

// Delete data pelanggan - GANTI DARI DELETE KE POST
Route::post('/report/operational/{id}/delete', [OperationalReportController::class, 'destroy'])
    ->name('report.operational.destroy');

// AJAX Routes untuk dropdown
Route::get('/report/operational/get-kabupaten', [OperationalReportController::class, 'getKabupaten'])
    ->name('report.operational.get-kabupaten');

Route::get('/report/operational/get-kode-fat', [OperationalReportController::class, 'getKodeFat'])
    ->name('report.operational.get-kode-fat');

Route::resource('report/operational', OperationalReportController::class)->parameters([
    'operational' => 'id'
]);
