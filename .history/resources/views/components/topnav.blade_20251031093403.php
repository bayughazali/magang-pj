      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
         ...
         <!-- User Management - Semua user bisa lihat, tapi submenu Admin hanya untuk admin -->
            <li class="ni ni-single-02 text-info mr-1"></i> User Management</li>
...
@auth
<li class="nav-item dropdown">
    <a class="nav-link pr-0 text-dark" href="#" id="userDropdown"
       role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
        <div class="dropdown-header navi-header font-weight-bold py-2">
            <span class="font-weight-bold">{{ auth()->user()->name ?? 'User' }}</span>
            <span class="text-muted font-size-sm d-block mt-1">{{ auth()->user()->email }}</span>
        </div>
