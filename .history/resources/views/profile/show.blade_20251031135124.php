...
<div class="col-lg-4">
    <div class="card shadow-lg border-0">
        ...
        <div class="card-body">
            ...
            <!-- Account Details -->
            <div class="card shadow-sm border-0 p-4" style="min-height: 80vh;">
            <h5 class="fw-bold mb-4">Informasi Akun</h5>
            <div class="text-center mb-4">
                <img src="{{ asset('path/to/profile.jpg') }}" class="rounded-circle mb-3" width="120" height="120" alt="Profile">
                ...
                <table class="table table-borderless">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ Auth::user()->created_at->timezone('Asia/Makassar')->format('d M Y H:i') }}</td>
                        </tr>
                        <tr>
                            <td><strong>Terakhir Login:</strong></td>
                            <td>{{ Auth::user()->updated_at->timezone('Asia/Makassar')->format('d M Y H:i') }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
