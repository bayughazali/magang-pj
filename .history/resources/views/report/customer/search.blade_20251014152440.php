...
<!-- Modal Konfirmasi Hapus (kalau belum ada) -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="alert alert-warning"><strong id="customerName">-</strong></div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // onclick="deletePelanggan({{ $pelanggan->id }}, 'Nama Pelanggan')"
