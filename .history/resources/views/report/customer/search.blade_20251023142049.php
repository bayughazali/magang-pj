                    ...
                    <div id="basicSearchForm">
                        <form method="GET" action="{{ route('customer.search') }}">
                            <div class="row g-3">
                                ...
                                <form action="{{ route('report.operational.index') }}" method="GET">
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-3">
            ...
            <div class="btn-group w-100">
                ...
                <a href="{{ route('report.operational.index') }}" class="btn btn-outline-secondary">
...
<script>
function deletePelanggan(id, nama) {
    console.log("Delete terpanggil:", id, nama);
