                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm" role="group">
                                        ...
                                        <form action="{{ route('report.operational.destroy', $p->id) }}"
                                              ...
                                              onsubmit="return confirm('Yakin ingin menghapus data pelanggan {{ $p->nama_pelanggan }}?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
...
{{-- JavaScript untuk konfirmasi hapus dengan SweetAlert (Optional) --}}
<script>
// Jika Anda menggunakan SweetAlert2, uncomment kode di bawah ini
/*
document.addEventListener('DOMContentLoaded', function() {
    ...
    deleteForms.forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            const namaPelanggan = this.closest('tr').querySelector('td:nth-child(3)').textContent;

            Swal.fire({
                title: 'Konfirmasi Hapus',
                text: `Yakin ingin menghapus data pelanggan ${namaPelanggan}?`,
                icon: 'warning',
