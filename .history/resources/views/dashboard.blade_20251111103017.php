...
<style>
    /* Style untuk card aktivitas sales agar lebih bagus dan centered */
    #salesDetailContent .row {
        display: flex;
        justify-content: center;
        align-items: stretch;
    }

    #salesDetailContent .col-md-6 {
        display: flex;
        margin-bottom: 1.5rem;
    }

    #salesDetailContent .card {
        width: 100%;
    ...
    #salesDetailContent .card:hover {
        transform: translateY(-5px);
        box-shadow: 0 8px 20px rgba(0, 0, 0, 0.15);
    }

    #salesDetailContent .card-body {
        display: flex;
        flex-direction: column;
        flex-grow: 1;
        padding: 1.5rem;
    ...
    /* Untuk tampilan desktop lebih lebar */
    ...
    /* Untuk tampilan yang lebih kecil */
