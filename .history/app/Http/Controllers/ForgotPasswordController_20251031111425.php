...
class ForgotPasswordController extends Controller
{
    ...
    public function showResetPasswordForm()
    {
        ...
        return view('uth.reset-passworad');
    }
    ...
    public function resetPassword(Request $request)
    {
        ...
        $email = session('email');
        $resetRequestId = session('reset_request_id');
        ...
        // Tandai request sebagai sudah digunakan
        if ($resetRequestId) {
            $resetRequest = PasswordResetRequest::find($resetRequestId);
            if ($resetRequest) {
        ...
        // Hapus semua session
        session()->forget(['email', 'verified', 'reset_request_id']);
