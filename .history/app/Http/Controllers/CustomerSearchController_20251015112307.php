...
class CustomerSearchController extends Controller
{
    ...
    public function destroy($id)
    {
          ...
          $pelanggan = Pelanggan::find($id);
            if (!$pelanggan) return response()->json(['message' => 'Data pelanggan tidak ditemukan.'], 404);
            $pelanggan->delete();
        ...
        // Log bahwa request delete diterima
        \Log::info("Delete request received for ID: {$id}");

        // Cari pelanggan, jika tidak ada akan lempar exception otomatis
        $pelanggan = Pelanggan::findOrFail($id);
