...
class OperationalReportController extends Controller
{
    ...
    {
     // Ambil ID terakhir dari tabel pelanggan atau report, tergantung kebutuhan kamu
    $lastId = DB::table('pelanggans')->max('id'); // contoh pakai tabel 'pelanggans'

    // Jika tidak ada data, mulai dari 1
    $nextId = $lastId ? $lastId + 1 : 1;

    // Kirim ke view
    return view('report.operational.index', compact('nextId'));
    }
