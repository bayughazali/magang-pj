...
// ==========================================
// FILE: app/Http/Controllers/OperationalReportController.php
// ==========================================
namespace App\Http\Controllers;
...
class OperationalReportController extends Controller
{
    ...
    public function edit($id)
    {
        try {
            ...
            // Data region untuk dropdown (sesuaikan dengan data Anda)
    ...
    /**
     * Hapus data pelanggan - FIXED VERSION dengan Error Handling
     */
    public function destroy($id)
    {
        try {
            // Cari pelanggan, jika tidak ada akan throw exception
            ...
            if (!$pelanggan) {
                ...
                return redirect()
                    ->route('report.operational.index')
                    ->withErrors(['error' => "Data pelanggan dengan ID {$id} tidak ditemukan"]);
            }
            ...
            Log::info("Data pelanggan {$nama} (ID: {$id}) berhasil dihapus");

            return redirect()
                ->route('report.operational.index')
                ->with('success', "Data pelanggan {$nama} berhasil dihapus!");

        } catch (\Exception $e) {
            Log::error("Error saat menghapus pelanggan ID {$id}: " . $e->getMessage());
    ...
    /**
     * Helper method untuk mendapatkan data region
     */
    public function showMap(Request $request)
{
    ...
    {
        return [
            'Bali' => ['Badung', 'Denpasar', 'Gianyar', 'Tabanan', 'Klungkung'],
            'Nusa Tenggara Barat' => ['Lombok Barat', 'Lombok Tengah', 'Lombok Timur', 'Mataram', 'Dompu'],
            'Nusa Tenggara Timur' => ['Kupang', 'Ende', 'Flores Timur', 'Sumba Barat', 'Sumba Timur'],
        ];
    }
